...
if a == b:
    ...
    print("Nope! Something is wrong and the files aren't precisely identical. \n")

print("COMPARE WITH YOUR SEARCHING LIST:\n")
### JSON A ###
...
if not_founded_a == not_founded_b:
    print("In both json's files not founded the same keys.")
else:
    print("The json's files have a different 'not_founded' keys.\n")
